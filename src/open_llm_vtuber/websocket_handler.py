...
class WebSocketHandler:
    ...
    async def _send_initial_messages(
        ...
        model_info = None
        if (
            session_service_context.live2d_model is not None
            and hasattr(session_service_context.live2d_model, "model_info")
        ):
    ...
    async def _handle_init_config_request(
        ...
        model_info = None
        if context is not None and context.live2d_model is not None:
