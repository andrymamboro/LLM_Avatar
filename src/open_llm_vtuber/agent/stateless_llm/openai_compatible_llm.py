...
class AsyncLLM(StatelessLLMInterface):
    ...
    async def chat_completion(
        ...
        try:
            ...
            # Automatically strip multimodal contents (images) if the model does not support it
            vision_keywords = ["vision", "-vl", "gpt-4o", "gpt-4-turbo", "gemini", "claude-3", "pixtral", "llava", "fuyu", "bakllava", "minicpm"]
            ...
            if not supports_vision:
                ...
                messages_with_system = cleaned_messages
